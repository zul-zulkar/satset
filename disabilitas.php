<?php
$jenis = "disabilitas"; // dikunci hanya untuk disabilitas
?>
...
<head>
    <meta charset="UTF-8">
    <title>Registrasi Antrian Disabilitas</title>
    <meta name="viewport" content="width=device-width, initial-scale=1"> <!-- Responsive -->
    <script src="https://cdn.tailwindcss.com"></script>
</head>
<body class="bg-gray-100 p-4 sm:p-10">
<div class="w-full max-w-xl mx-auto bg-white p-6 rounded shadow">
    <h1 class="text-xl sm:text-2xl font-bold mb-4 text-center">Form Antrean Disabilitas</h1>
...
<script>
    setInterval(() => {
        fetch("antrean_sekarang.php?jenis=disabilitas")
            .then(res => res.text())
            .then(data => {
