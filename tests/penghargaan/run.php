 ...
 *
 * Usage:
 *   php tests/penghargaan/run.php          # jalankan semua suite
 *   php tests/penghargaan/run.php unit     # hanya unit test
 *   php tests/penghargaan/run.php schema   # hanya schema/DB test
 *   php tests/penghargaan/run.php api      # hanya HTTP endpoint test
 *
 * Keluar dengan exit code 1 jika ada test yang gagal (cocok untuk CI).
 */

chdir(dirname(__DIR__, 2)); // Set ke root project (c:\xampp\htdocs\satset)
