...
`.git/`, `internal/` (berisi `backup/`, `input/`, `sql_production/`, `tests/`, `deploy/`), `node_modules/`, `*.zip`

> Butuh berkas SQL untuk import database? Ambil dari folder `internal/sql_production/`
