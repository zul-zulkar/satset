<?php
/**
 * Absensi Test Runner — unit (logika murni) + runtime (auth guard).
 * Jalankan: php internal/tests/absensi/run.php
 */
require_once __DIR__ . '/../_lib/T.php';

echo "\n\e[1m\e[34m╔══════════════════════════════════════════════════╗\e[0m\n";
echo "\e[1m\e[34m║   Absensi Tests — Login, Jadwal, Auth Guard      ║\e[0m\n";
